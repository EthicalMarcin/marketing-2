...
export const Nav20DataSource = {
  isScrollLink: true,
  wrapper: { className: 'header2 home-page-wrapper k3gtsgkq9hq-editor_css' },
  page: { className: 'home-page k3gt36u03e-editor_css' },
  logo: {
    className: 'header2-logo k3gt302bunm-editor_css',
    ...
    children: [
      {
        ...
        to: 'Banner1_1',
        children: 'Home',
        className: 'menu-item k3gwcu3pqt-editor_css',
      },
      {
        name: 'Feature2_0',
        to: 'Feature2_0',
        children: 'Kontakt',
        className: 'menu-item k3gsxwq8lji-editor_css',
      },
      {
        name: 'Feature6_0',
        to: 'Feature6_0',
        children: 'Ciekawostki',
        className: 'menu-item k3gsxymikga-editor_css',
      },
      {
        name: 'Feature5_0',
        to: 'Feature5_0',
      ...
      },
      {
        ...
        content: {
          ...
          children: (
            <>
              <p>
                Organizujemy transporty na terenie całej Unii Europejskiej oraz Bliskiego Wschodu. Wszystkie zlecenia realizowane są nowoczesnymi samochodami, spełniającymi najwyższe i najbardziej surowe wymagania Unii Europejskiej
              </p>
            </>
          ),
        },
      ...
      },
      {
        ...
        content: {
          ...
          children: (
            <>
              <p>
                kompleksową obsługę przesyłek w relacji import/eksport oraz przywóz/wywóz na terenie Europy
                organizację przewozów całopojazdowych, częściowych, doładunków, drobnicowych
                sieć sprawdzonych i doświadczonych podwykonawców, starannie dobranych i zweryfikowanych
                niezbędny tabor samochodowy do obsługi każdego typu towarów
...
export const Feature50DataSource = {
  wrapper: {
    className: 'home-page-wrapper content7-wrapper k3gvag613tc-editor_css',
  },
  page: { className: 'home-page content7 k3gwix4izl-editor_css' },
  OverPack: {},
  titleWrapper: {
    ...
    children: [
      {
        ...
        className: 'title-h1 k3gvov8tlrf-editor_css',
      },
      {
        name: 'content',
        children: (
          <>
            <p>Poznaj nasze możliwości</p>
          </>
        ),
        className: 'k3gvnslunip-editor_css',
      },
    ],
  },
    ...
    children: [
      {
        ...
        tag: {
          ...
          text: {
            ...
            className: 'content7-tag-name k3gwn0f35rk-editor_css',
          },
          icon: { children: 'arrow-down' },
        },
        content: {
          ...
          text: {
            ...
            children: (
              <>
                <span>
                  <h3>
                    <b>Do naszej oferty należy przewóz krajowy obejmujący:</b>
                  </h3>
                  <p>
                    <br />
                  </p>
                  <p>
                    -Przewóz wszystkich rodzajów ładunków w tym ubocznych
                    produktow pochodzenia zwierzęcego oraz odpadów
                  </p>
                  <p>-transporty całopojazdowe</p>
                  <p>-stały monitoring</p>
                  <p>
                    <br />
                  </p>
                  <p>
                    Przewożone przez nas ładunki ubezpieczone są w ramach umowy
                    ubezpieczenia OC przewoźnika drogowego w ruchu krajowym na
                    sumę gwarancyjną 350 000 EUR.
                  </p>
                  <p>
                    <br />
                  </p>
          ...
          img: {
            className: 'content7-img k3gvrgvvtyn-editor_css',
            children:
              'https://www.renault-trucks.com/media/image/renault-trucks-gamme-t-2019-1600x896.jpg',
            md: 10,
            xs: 24,
          },
        },
      },
      {
        ...
        tag: {
          className: 'content7-tag',
          icon: { children: 'heat-map' },
          text: {
            className: 'content7-tag-name k3gwn6ar2c6-editor_css',
            children: (
              <>
        ...
        content: {
            ...
            children: (
              <>
                <span>
                  <h3>
                    <b>
                      Firma TransBart świadczy usługi transportowe na terytorium
                  ...
                  <blockquote>
                    -przewóz wszystkich rodzajów ładunków w tym ubocznych
                    produktów pochodzenia zwierzęcego oraz odpadów
                  </blockquote>
                  <p>
                    -transporty w temperaturze kontrolowanej(naczepy chłodnie)
                  </p>
                  <p>
                    -transporty całopojazdowe i częściowe oraz&nbsp;<span>
                      stały monitoring ładunku
                    </span>
                  </p>
                  <p>-możliwość wymiany palet</p>
                  <p>-transport makulatury</p>
                </span>
              </>
            ),
          },
          img: {
            ...
            xs: 24,
            children:
              'https://imgr1.eurotransport.de/Renault-Trucks-T-High-Edition-Protect-articleDetail-d96b741b-315617.jpg',
          },
        },
      },
      {
        ...
        tag: {
          ...
          text: {
            ...
            className: 'content7-tag-name k3gwnct5wx9-editor_css',
          },
          icon: { children: 'arrow-right' },
        },
        content: {
          className: 'content7-content',
          text: {
            ...
            children: (
              <>
                <p>
                  Przedsiębiorstwi&nbsp; Trans-Bart&nbsp; świadczy również
                  usługi <b>spedycyjno-transportowe.</b> Cechuje nas ekspresowe
                  i zawsze pewne działanie zapewniając kompleksową usługę
                  transportu rzesyłek drobnicowych oraz całopojazdowych w
                  systemie "Just in Time". Organizujemy transporty na terenie
                  całej Uni Europejskiej oraz Bliskiego Wschodu. Wszystkie
                  zlecenia realizowane są nowoczesnymi samochodami,
                  spełanijącymi najwyższe i najbardziej surowe wymagania Uni
                  europejskiej, a zatrudniani przez nas pracownicy posiadają
          ...
          img: {
            ...
            md: 10,
            xs: 24,
            children: 'https://www.e3spedition.com/images/cities/vogne.jpg',
          },
        },
      },
    ],
...
export const Feature60DataSource = {
  ...
  Carousel: {
    className:
      'feature6-content k3g1yx7i8m-editor_css k3g2e5xf7mc-editor_css k3gx891jfak-editor_css',
    dots: false,
        ...
        children: [
          {
            ...
            name: 'child0',
            number: {
              className: 'feature6-number k3gxaymvwn-editor_css',
              unit: {
          ...
          },
          {
            ...
            name: 'child1',
            number: {
              className: 'feature6-number k3gxb4momv-editor_css',
              unit: {
                className: 'feature6-unit',
                children: (
                  <>
          ...
          },
          {
            ...
            name: 'child2',
            number: {
              className: 'feature6-number k3gxbnfo2l-editor_css',
              unit: {
                className: 'feature6-unit',
                children: (
                  <>
        ...
        childWrapper: {
          children: [
            ...
            },
            {
              ...
              className: 'k3gx7ekr9co-editor_css',
              children: (
                <>
                  <p>
                    <br />
